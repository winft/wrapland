...
private:
    ...
    Srv::PlasmaWindowManager *m_pwInterface = nullptr;
...
void PlasmaWindowModelTest::init()
{
    ...
    m_display->createShm();
    m_pwInterface = m_display->createPlasmaWindowManager();
    ...
    m_pwInterface->setVirtualDesktopManager(m_serverPlasmaVirtualDesktopManager);
