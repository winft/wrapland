...
private:
    static void
    createCallback(SlideManagerGlobal::bind_t* bind, uint32_t id, wl_resource* wlSurface);
    static void unsetCallback(SlideManagerGlobal::bind_t* bind, wl_resource* wlSurface);
