...
private:
    static void
    createSurfaceCallback(PlasmaShellGlobal::bind_t* bind, uint32_t id, wl_resource* surface);
    void createSurface(PlasmaShellGlobal::bind_t* bind, uint32_t id, Surface* surface);
