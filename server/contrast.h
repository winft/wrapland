 ...
 *
 * This class creates Contrasts and attaches them to SurfaceInterfaces.
 *
 * @see Contrast
 ...
 *
 * Instances of this class are only generated by the ContrastManager.
 * The Contrast gets attached to a SurfaceInterface and can be assessed
 * from there using @link SurfaceInterface::contrast() @endlink. Please note that
 * the Contrast is only available on the SurfaceInterface after it has been
 * committed.
 *
 * @see ContrastManager
 * @see SurfaceInterface
