...
{
    newSeat->setName(name.toUtf8().constData());
//    Q_D();
//    if (d->name == name) {
//        return;
//    }
...
{
    return QString::fromStdString(newSeat->name());
//    Q_D();
//    return d->name;
}
...
{
    auto seat = Server::Seat::get(native->data);
    return seat->legacy;
}
...
{
    newSeat->setFocusedPointerSurfacePosition(surfacePosition);
//    Q_D();
//    if (d->globalPointer.focus.surface) {
//        d->globalPointer.focus.offset = surfacePosition;
...
{
    return newSeat->focusedPointerSurfacePosition();
//    Q_D();
...
{
    newSeat->setFocusedPointerSurfaceTransformation(transformation);
//    Q_D();
//    if (d->globalPointer.focus.surface) {
//        d->globalPointer.focus.transformation = transformation;
//    }
...
{
    return newSeat->focusedPointerSurfaceTransformation();
//    Q_D();
...
{
    return newSeat->isPointerButtonPressed(button);
...
{
    newSeat->pointerAxisV5(orientation, delta,discreteDelta,source);
//    Q_D();
//    if (d->drag.mode == Private::Drag::Mode::Pointer) {
//        // ignore
//        return;
...
{
    newSeat->pointerAxis(orientation,delta);
//    Q_D();
//    if (d->drag.mode == Private::Drag::Mode::Pointer) {
//        // ignore
//        return;
...
{
    newSeat->pointerButtonPressed(button);
...
{
    newSeat->pointerButtonReleased(button);
//    const quint32 nativeButton = qtToWaylandButton(button);
//    if (nativeButton == 0) {
//        return;
//    }
...
{
    return newSeat->pointerButtonSerial(button);
...
{
    newSeat->relativePointerMotion(delta, deltaNonAccelerated,microseconds);
//    Q_D();
//    if (d->globalPointer.focus.surface) {
//        for (auto it = d->globalPointer.focus.pointers.constBegin(), end = d->globalPointer.focus.pointers.constEnd(); it != end; ++it) {
...
{
    newSeat->startPointerSwipeGesture(fingerCount);
//    Q_D();
...
{
    newSeat->updatePointerSwipeGesture(delta);
//    Q_D();
//    if (d->globalPointer.gestureSurface.isNull()) {
//        return;
//    }
...
{
    newSeat->endPointerSwipeGesture();
//    Q_D();
//    if (d->globalPointer.gestureSurface.isNull()) {
//        return;
//    }
...
{
    newSeat->cancelPointerSwipeGesture();
//    Q_D();
//    if (d->globalPointer.gestureSurface.isNull()) {
//        return;
//    }
...
{
    newSeat->startPointerPinchGesture(fingerCount);
//    Q_D();
//    if (!d->globalPointer.gestureSurface.isNull()) {
//        return;
//    }
...
{
    newSeat->updatePointerPinchGesture(delta, scale, rotation);
//    Q_D();
//    if (d->globalPointer.gestureSurface.isNull()) {
//        return;
//    }
...
{
    newSeat->endPointerPinchGesture();
//    Q_D();
//    if (d->globalPointer.gestureSurface.isNull()) {
//        return;
//    }
...
{
    newSeat->cancelPointerPinchGesture();
//    Q_D();
//    if (d->globalPointer.gestureSurface.isNull()) {
//        return;
//    }
...
{
    newSeat->updateKeyboardModifiers(depressed,latched, locked, group);
//    Q_D();
//    bool changed = false;
//#define UPDATE( value ) \
...
{
    newSeat->setKeyRepeatInfo(charactersPerSecond, delay);
//    Q_D();
...
{
    return newSeat->isKeymapXkbCompatible();
//    Q_D();
...
{
    return newSeat->keymapFileDescriptor();
//    Q_D();
...
{
    return newSeat->depressedModifiers();
//    Q_D();
...
{
    return newSeat->latchedModifiers();
//    Q_D();
...
{
    return newSeat->lockedModifiers();
//    Q_D();
...
{
    return newSeat->lastModifiersSerial();
//    Q_D();
...
{
    return newSeat->hasImplicitPointerGrab(serial);
//    Q_D();
...
{
    return newSeat->dragSurfaceTransformation();
//    Q_D();
