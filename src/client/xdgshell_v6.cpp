...
void XdgShellUnstableV6::Private::pingCallback(void* data,
...
XdgShellPopup* XdgShellUnstableV6::Private::getXdgPopup(Surface* surface,
                                                        XdgShellSurface* parentSurface,
                                                        const XdgPositioner& positioner,
                                                        QObject* parent)
{
...
XdgShellPopup* XdgShellUnstableV6::Private::internalGetXdgPopup(Surface* surface,
                                                                zxdg_surface_v6* parentSurface,
                                                                const XdgPositioner& positioner,
                                                                QObject* parent)
{
...
void XdgTopLevelUnstableV6::Private::surfaceConfigureCallback(void* data,
...
void XdgTopLevelUnstableV6::Private::configureCallback(void* data,
                                                       struct zxdg_toplevel_v6* xdg_toplevel,
                                                       int32_t width,
                                                       int32_t height,
                                                       struct wl_array* state)
...
void XdgShellPopupUnstableV6::Private::configureCallback(void* data,
                                                         zxdg_popup_v6* xdg_popup,
                                                         int32_t x,
                                                         int32_t y,
                                                         int32_t width,
...
void XdgShellPopupUnstableV6::Private::surfaceConfigureCallback(void* data,
                                                                struct zxdg_surface_v6* surface,
                                                                uint32_t serial)
{
    Q_UNUSED(surface);
