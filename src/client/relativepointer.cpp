...
public:
    ...
    WaylandPointer<zwp_relative_pointer_manager_v1, zwp_relative_pointer_manager_v1_destroy>
...
void RelativePointerManager::setup(
...
RelativePointer* RelativePointerManager::createRelativePointer(Pointer* pointer, QObject* parent)
{
    ...
    auto w = zwp_relative_pointer_manager_v1_get_relative_pointer(
        d->relativepointermanagerunstablev1, *pointer);
    if (d->queue) {
        d->queue->addProxy(w);
    }
    p->setup(w);
...
public:
    ...
    WaylandPointer<zwp_relative_pointer_v1, zwp_relative_pointer_v1_destroy>
...
void RelativePointer::Private::relativeMotionCallback(
    void* data,
    zwp_relative_pointer_v1* zwp_relative_pointer_v1,
    uint32_t utime_hi,
    uint32_t utime_lo,
